...
import com.educationcurb.thword.view.gamestuff.RampageEndPopup;
...
class SingleRampage extends Sprite
{
    ...
    private function onCheckWord(e : Event) : Void
    {
        ...
        //sndFactory.playSoundEffect(new menu_click());
    ...
    private function movePoints() : Void
    {
        ...
        /*TweenMax.to(txtPoints, 0.1, {
                    y : txtPoints.y - txtPoints.height - BTN_SPACE
                });  */
