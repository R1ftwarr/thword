...
//import aSWC.media.SoundManager;
...
class RampageEndPopup extends Sprite
{
    ...
    //Best Score Particle
    //@:meta(Embed(source="../../assets/textures/highscore.pex",mimeType="application/octet-stream"))

    //private static var BestScoreConfig : Class<Dynamic>;
    //@:meta(Embed(source="../../assets/textures/highscore.png"))
    ...
    private function createHighScoreParticle() : Void
    {
        ...
        //var bestConfig : FastXML = FastXML.parse(Type.createInstance(BestScoreConfig, []));
        //var bestTexture : Texture = Texture.fromBitmap(Type.createInstance(BestScoreParticle, []));
